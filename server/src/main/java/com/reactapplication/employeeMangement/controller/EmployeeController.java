package com.reactapplication.employeeMangement.controller;

import com.reactapplication.employeeMangement.exception.ResourceNotFoundException;
...
@CrossOrigin("*")
//@CrossOrigin(origins = {"http://localhost:3000/"}) only allows this client
@RestController
